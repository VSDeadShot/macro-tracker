...
export default function InstallPWA() {
  ...
  return (
    <button 
      ...
      className="w-10 h-10 rounded-full bg-card border border-white/5 flex items-center justify-center text-white/50 shadow-sm hover:border-primary/30 transition-colors mr-3 animate-in fade-in"
    >
